...
https://faratim.github.io/meet-app/
...
1. Welcome-page of Meet App
   <img alt="A screenshot of the welcome-page of Meet App" src="/src/img/Screenshot1.png" width="100%">

2. Meet App after sign in with google account
   <img alt="A screenshot of the Meet App after sign in with google account" src="/src/img/Screenshot2.png" width="100%">

3. Giving 'Berlin' in the search field
   <img alt="A screenshot after giving 'Berlin' in the search field." src="/src/img/Screenshot3.png" width="100%">

4. PWA feature
   <img alt="A screenshot when the app is offline." src="/src/img/Screenshot4.png" width="100%">
